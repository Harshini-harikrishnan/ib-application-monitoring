...
namespace BankMonitoringAPI.Migrations
{
    ...
    [Migration("20250623184654_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebMonitorAPI.Models.PerformanceMetrics", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<decimal?>("BestPracticesScore")
                        .HasColumnType("numeric");
            ...
            modelBuilder.Entity("WebMonitorAPI.Models.Site", b =>
                {
                    ...
                    b.Property<DateTime?>("LastPerformanceAudit")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("WebMonitorAPI.Models.Site", b =>
                {
                    b.HasOne("WebMonitorAPI.Models.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
