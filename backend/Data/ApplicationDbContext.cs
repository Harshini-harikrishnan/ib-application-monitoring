...
namespace WebMonitorAPI.Data
{
    public class ApplicationDbContext : IdentityDbContext<User>
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            // Configure Site entity - Fix the foreign key relationship
            builder.Entity<Site>(entity =>
            {
                ...
                // Explicit foreign key relationship with User
                entity.HasOne<User>()
                    .WithMany()
            ...
            builder.Entity<SSLCertificate>(entity =>
            {
                ...
                // Foreign key relationship with Site
            ...
            builder.Entity<SSLCheckResult>(entity =>
            {
                ...
                // Foreign key relationship with SSLCertificate
